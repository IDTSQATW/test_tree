...
C2C06.append(["Auth Block 53 - changed keyB","2C 06 34 02 22 22 22 22 22 22","5669564F7465636832002C0000001C9B"])

C2C07 = []
C2C07.append(["Read Initialized Blocks 52","2C 07 31 34","5669564F7465636832002C0000108619000079E6FFFF8619000000FF00FF"])
C2C07.append(["Read Initialized Blocks 54","2C 07 31 36","5669564F7465636832002C00001011111111111111111111111111111111"])
C2C07.append(["Read 52 -DECed","2C 07 31 34","5669564F7465636832002C0000108719000078E6FFFF8719000000FF00FF"])
C2C07.append(["Read 54 -Changed","2C 07 31 36","5669564F7465636832002C0000108719000078E6FFFF8719000000FF00FF"])

C2C08 = []
C2C08.append(["Initialize Blocks 52","2C 08 31 34 8619000079E6FFFF8619000000FF00FF","5669564F7465636832002C0000001C9B"])
C2C08.append(["Initialize Blocks 54","2C 08 31 36 11111111111111111111111111111111","5669564F7465636832002C0000001C9B"])
C2C08.append(["Write Key Block 55 - changed","2C 08 31 37 11 11 11 11 11 11 7F 07 88 69 22 22 22 22 22 22","5669564F7465636832002C0000001C9B"])
...
C2C0A = []
C2C0A.append(["1.Inc Block 52 with backup - Backup with correct keyB","2C 0A B2 34 0B 01 00 00 00 02 22 22 22 22 22 22 36 08 34 02 22 22 22 22 22 22","5669564F7465636832002C000000"])
...
#Inc Block 52 with backup - Backup with correct keyB
...
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C06[2][0],C2C06[2][1],5000,False,DL),C2C06[1][2],DL)): DL.fails = DL.fails +1
