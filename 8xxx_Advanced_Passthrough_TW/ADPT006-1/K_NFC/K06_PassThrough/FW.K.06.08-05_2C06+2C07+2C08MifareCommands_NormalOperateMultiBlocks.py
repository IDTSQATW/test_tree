...
C2C07 = []
C2C07.append(["Read 15Blocks, starting Block #0","2C 07 3F 00","5669564F7465636832002C0000F0???????????????????????????????? 1111111111111111111111111111111122222222222222222222222222222222 **"])
C2C07.append(["Read 15Blocks, starting Block #0","2C 07 3F 00","5669564F7465636832002C0000F0????????????????????????????????00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 **"])
...
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C08[0][0],C2C08[0][1],50000,False,DL),C2C08[0][2],DL)): DL.fails = DL.fails +1
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C07[0][0],C2C07[0][1],50000,False,DL),C2C07[0][2],DL)): DL.fails = DL.fails +1
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C08[1][0],C2C08[1][1],50000,False,DL),C2C08[1][2],DL)): DL.fails = DL.fails +1
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C07[1][0],C2C07[1][1],50000,False,DL),C2C07[1][2],DL)): DL.fails = DL.fails +1
