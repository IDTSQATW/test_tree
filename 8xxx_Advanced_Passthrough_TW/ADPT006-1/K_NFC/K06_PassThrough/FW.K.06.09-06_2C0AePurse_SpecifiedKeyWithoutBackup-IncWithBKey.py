...
C2C06 = []
C2C06.append(["0.Authenticate - Default","2C 06 31 01 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])
C2C06.append(["1.Authenticate - Changed Key","2C 06 35 01 11 22 33 44 55 66","5669564F7465636832002C0000001C9B"])
C2C06.append(["2.Auth Block55 - changed keyB","2C 06 37 02 66 55 44 33 22 11","5669564F7465636832002C0000001C9B"])

C2C07 = []
C2C07.append(["0.Read 3 Initialized Blocks 52-54","2C 07 33 34","5669564F7465636832002C0000308619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF0F7B"])
C2C07.append(["2.Read 52-54 -INCed","2C 07 33 34","5669564F7465636832002C0000308719000078E6FFFF8719000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF4CD2"])

C2C08 = []
C2C08.append(["0.Initialize Blocks 52-54","2C 08 33 34 8619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF","5669564F7465636832002C0000001C9B"])
C2C08.append(["1.Write Key, Block 55","2C 08 31 37 11 22 33 44 55 66 7F 07 88 69 66 55 44 33 22 11","5669564F7465636832002C0000001C9B"])
C2C08.append(["2.Write Key Block 55 - default","2C 08 31 37 FF FF FF FF FF FF FF 07 80 69 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])

C2C0A = []
C2C0A.append(["Increment Block 52 without backup - with correct B key","2C 0A B1 34 0B 01 00 00 00 02 66 55 44 33 22 11","5669564F7465636832002C000000"])
...
#Increment Block 52 without backup - with correct B key
...
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C06[2][0],C2C06[2][1],5000,False,DL),C2C06[2][2],DL)): DL.warnings = DL.warnings +1
