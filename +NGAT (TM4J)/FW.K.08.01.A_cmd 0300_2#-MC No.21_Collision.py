...
# cmd 03-00
if (Result):
	DL.ShowMessageBox("CL card", "Tap two 2#-MC No.21_Collision card (Collision, 2 beep sound), then click OK", 0)
	DL.SetWindowText("black",'----- cmd 03-00')
	DL.SendIOCommand("IDG", "0300", 32000, 1) 
	Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 03 00")
	
# cmd 03-40
if (Result):
	DL.ShowMessageBox("CL card", "Tap two 2#-MC No.21_Collision card (Collision), then click OK", 0)
