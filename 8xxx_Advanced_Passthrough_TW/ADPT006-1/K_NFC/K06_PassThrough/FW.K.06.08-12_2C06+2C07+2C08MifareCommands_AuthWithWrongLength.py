...
C2C06Wrong = []
C2C06Wrong.append(["Auth -length-1","2C 06 04 01 FF FF FF FF FF","5669564F7465636832002C05"])
C2C06Wrong.append(["Auth -length+1","2C 06 04 01 FF FF FF FF FF FF FF","5669564F7465636832002C05"])
...
#2C-06 with wrong parameters
for Case in C2C06Wrong:
