...
C2C07= []
C2C07.append(["Read Block #1 - 11","2C 07 31 01","5669564F7465636832002C00 0030 0020** 000A** 0000","0010 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11"])
C2C07.append(["Read 15Blocks, starting Block #0","2C 07 3F 00","5669564F7465636832002C00 0110 0100** 000A** 0000","00F0 ???????????????????????????????? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 **"])
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,False,C2C07[1][3],DL)
ListKSN.append(ListAPDU[0])
