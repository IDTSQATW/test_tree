...
C2C07= []
C2C07.append(["Read Block FF","2C 07 31 FF","5669564F7465636832002C0A"])
...
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C06[0][0],C2C06[0][1],50000,False,DL),C2C06[0][2],DL)): DL.warnings = DL.warnings +1
