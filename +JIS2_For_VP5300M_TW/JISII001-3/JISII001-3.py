				...
				if sResult!=None and sResult!="":
					...
					if CardData!=None and CardData!='':
						...
						if objectMSR!=None:
							...
							#TR1plaintextdata = "25545241434B333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333F55"
							...
							Result = DL.Check_StringAB(CardData, '02 5F 00 83 0F 4E 00 00 91 00')
							if Result == False:
