...
StatusCode VIVOAPI System_SearchForDevice(char* deviceCategory , char* devicePath[]); 
...
StatusCode VIVOAPI Passthrough_PollForToken(int timeOutMS, Data* tokenInformation);
...
StatusCode VIVOAPI Payment_GetFullTrackData(Information* cardInformation, TrackData* trackData);
