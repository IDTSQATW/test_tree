...
C2C06.append(["Authenticate - Changed Key","2C 06 35 01 11 22 33 44 55 66","5669564F7465636832002C0000001C9B"])
C2C06.append(["Auth Block55 - changed keyB","2C 06 37 02 66 55 44 33 22 11","5669564F7465636832002C0000001C9B"])

C2C07 = []
C2C07.append(["Read 3 Initialized Blocks 52-54","2C 07 33 34","5669564F7465636832002C0000308719000078E6FFFF8719000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF4CD2"])
C2C07.append(["Read 52-54 -Deced","2C 07 33 34","5669564F7465636832002C0000308619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF0F7B"])

C2C08 = []
C2C08.append(["Initialize Blocks 52-54","2C 08 33 34 87 19 00 00 78 E6 FF FF 87 19 00 00 00 FF 00 FF B7 1A 00 00 48 E5 FF FF B7 1A 00 00 00 FF 00 FF 88 19 00 00 77 E6 FF FF 88 19 00 00 00 FF 00 FF","5669564F7465636832002C0000001C9B"])
C2C08.append(["Write Key, Block 55","2C 08 31 37 11 22 33 44 55 66 7F 07 88 69 66 55 44 33 22 11","5669564F7465636832002C0000001C9B"])
C2C08.append(["Write Key Block 55 - default","2C 08 31 37 FF FF FF FF FF FF FF 07 80 69 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])

C2C0A = []
C2C0A.append(["Decrement Block 52 without backup - with correct A key","2C 0A 31 34 0B 01 00 00 00 01 11 22 33 44 55 66","5669564F7465636832002C0000001C9B"])
...
#Decrement Block 52 without backup - with correct A key
