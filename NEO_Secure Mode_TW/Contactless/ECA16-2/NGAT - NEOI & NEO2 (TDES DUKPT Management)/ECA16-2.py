...
if (Result):
    ...
    if (RetOfStep):
        if platform == 1: #NEOII and upward
            Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 23 ** 63")
        if platform == 0: #NEOI
            Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 23 ** 43")
        ...
        if (Result):     
            ...
            if platform == 1: #NEOII and upward
                Result = DL.Check_RXResponse("DFEE26 02 6300")
            if platform == 0: #NEOI
                Result = DL.Check_RXResponse("DFEE26 01 43")
            if Result == False:
                DL.fails=DL.fails+1
