...
C2C40Tag1.append(["2.Tag1 Static Read a byte 01","2C 40 12 01","2C 00 0030 0010** 000A** 0010","00 02 01 "])
C2C40Tag1.append(["3.Tag1 Static Read a byte 02 ","2C 40 12 02","2C 00 0030 0010** 000A** 0010","00 02 02 "])
C2C40Tag1.append(["4.Tag1 Static Read a byte 0A","2C 40 12 0A","2C 00 0030 0010** 000A** 0010","00 02 0A "])
C2C40Tag1.append(["5.Tag1 Static Read a byte 09","2C 40 12 09","2C 00 0030 0010** 000A** 0010","00 02 09 "])
C2C40Tag1.append(["6.Tag1 Static Write a byte","2C 40 13 09 F2","2C 00 0030 0010** 000A** 0010","00 02 09 "])
C2C40Tag1.append(["7.Tag1 Static Write a byte NE","2C 40 14 0A FF","2C 00 0030 0010** 000A** 0010","00 02 0A"])
C2C40Tag1.append(["8.Tag1 Dynamic Read a segment","2C 40 15 12","2C 00 00B0 0090** 000A** 0010","00 81 12 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"])
...
while (index<6):
	...
	ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,True,C2C40Tag1[index][3]+strRead[index],DL)
...
while (index < 11):
	strRes=Pro_SendCmd().Run(C2C40Tag1[index][0],C2C40Tag1[index][1],50000,False,DL)
	if(False ==  Pro_SendCmd().RunCK_C(strRes,C2C40Tag1[index][2],DL)):DL.fails = DL.fails + 1
	ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,True,C2C40Tag1[index][3],DL)
	ListKSN.append(ListAPDU[0])
	index = index+1
