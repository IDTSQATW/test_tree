...
CN2C04 = []
CN2C04.append(["PCDWriteBlock4","2C 04 1E 00 00 29 68 01 07 A0 04 ","56 69 56 4F 74 65 63 68 32 00 2C00 0030 0010** 000A** 0010"," 00 06 00 00 00 00 08 0A"])
CN2C04.append(["PCD Write Data - 00s","2C 04 1E 00 00 29 68 01 07 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00","56 69 56 4F 74 65 63 68 32 00 2C00 0030 0010** 000A** 0010"," 00 06 00 00 00 00 08 0A"])
CN2C04.append(["PCD Read Block 4 - 00","2C 04 1E 00 00 29 68 01 0F 30 04","56 69 56 4F 74 65 63 68 32 00 2C00 0040 0020** 000A** 0010","00 15 00 00 00 00 80 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"])
CN2C04.append(["PCDWriteBlock4","2C 04 1E 00 00 29 68 01 07 A0 04 ","56 69 56 4F 74 65 63 68 32 00 2C00 0030 0010** 000A** 0010","00 06 00 00 00 00 08 0A"])
CN2C04.append(["PCD Write Data - 44s","2C 04 1E 00 00 29 68 01 07 44 44 44 44 44 44 44 44 44 44 44 44 44 44 44 44","56 69 56 4F 74 65 63 68 32 00 2C00 0030 0010** 000A** 0010","00 06 00 00 00 00 08 0A"])
CN2C04.append(["PCD Read Block 4 - 44","2C 04 1E 00 00 29 68 01 0F 30 04","56 69 56 4F 74 65 63 68 32 00 2C00 0040 0020** 000A** 0010"," 00 15 00 00 00 00 80 44 44 44 44 44 44 44 44 44 44 44 44 44 44 44 44"])
CN2C04.append(["PCD Read Block 5","2C 04 1E 00 00 29 68 01 0F 30 05","56 69 56 4F 74 65 63 68 32 00 2C 00 0040 0020** 000A** 0010"," 00 15 00 00 00 00 80",""])
CN2C04.append(["PCD Read Block 6","2C 04 1E 00 00 29 68 01 0F 30 06","56 69 56 4F 74 65 63 68 32 00 2C 00 0040 0020** 000A** 0010"," 00 15 00 00 00 00 80"])
