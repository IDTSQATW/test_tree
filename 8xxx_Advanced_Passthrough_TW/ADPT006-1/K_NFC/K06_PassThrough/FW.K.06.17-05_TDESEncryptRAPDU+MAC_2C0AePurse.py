...
C2C07 = []
C2C07.append(["Read 3 Initialized Blocks 16-18","2C 07 33 10","5669564F7465636832002C00 0058 0038** 000A** 0010","00308719000078E6FFFF8719000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF"])
C2C07.append(["Read 3 Initialized Blocks 32-34","2C 07 33 20","5669564F7465636832002C00 0058 0038** 000A** 0010","00308719000078E6FFFF8719000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF"])
C2C07.append(["Read 16 to 18-changed","2C 07 33 10","5669564F7465636832002C00 0058 0038** 000A** 0010","00308619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8619000079E6FFFF8619000000FF00FF"])
C2C07.append(["Read 32 to 34-changed","2C 07 33 20","5669564F7465636832002C00 0058 0038** 000A** 0010","00308619000079E6FFFF8619000000FF00FF8619000079E6FFFF8619000000FF00FF8819000077E6FFFF8819000000FF00FF"])
...
Pro_Encryption().DecRAPDU(strRes,strKey,0,1,False,True,C2C07[0][3],DL)
...
Pro_Encryption().DecRAPDU(strRes,strKey,0,1,False,True,C2C07[1][3],DL)
...
Pro_Encryption().DecRAPDU(strRes,strKey,0,1,False,True,C2C07[2][3],DL)
...
Pro_Encryption().DecRAPDU(strRes,strKey,0,1,False,True,C2C07[3][3],DL)
