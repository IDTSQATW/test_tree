...
C2C02 = []
C2C02.append(["2C-02 1b","2C 02 1E","56 69 56 4F 74 65 63 68 32 00 2C 05"])
C2C02.append(["2C-02 3b","2C 02 1E 00 00","56 69 56 4F 74 65 63 68 32 00 2C 05"])
##################################################
...
if(False ==  Pro_SendCmd().RunCK(Pro_SendCmd().Run(C2C02[1][0],C2C02[1][1],5000,False,DL),C2C02[1][2],DL)): DL.fails = DL.fails + 1
