...
C2C44=[]
C2C44.append(["Normal Write S_PAD1 -- 00",["2C 44 1F 08","01 09 00 01 80 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"],["2C 00 00 0B 09"," 00 00"]])
C2C44.append(["Normal Read S_PAD1 -- 00",["2C 44 0F 06","01 09 00 01 80 01"],["2C 00 00 1C 07","00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"]])
C2C44.append(["Normal Write S_PAD01 -- 11",["2C 44 1F 08","01 09 00 01 80 01 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11"],["2C 00 00 0B 09"," 00 00"]])
C2C44.append(["Normal Read S_PAD1&3&4&5 -- 11",["2C 44 15 06","01 09 00 04 80 01 80 03 80 04 80 05"],["2C 00 00 4C 07","00 00 04 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11"]])
...
for Case in C2C44:
	...
	response = Case[2][0]+strUID+Case[2][1]
