				...
				if lcdtype == 0:	
					...
					if (Result):
						...
						if (Result):
							...
							if (Result):
								Result = DL.Check_RXResponse(9, 'EC ** DF EE 25')
				...
				if sResult!=None and sResult!="":
					...
					if CardData!=None and CardData!='':
						...
						if objectMSR!=None:
							...
							decDFEF4D = DL.AES_DUPKT_EMVData_Decipher(KSN, strKey, TagDFEF4D)	
							...
							if DL.Check_StringAB(CardData, '80 5F 44 28 00 A3 9B') == False:
								DL.fails=DL.fails+1
