...
C2C44=[]
C2C44.append(["Normal Read ID","01 0B 00 01 80 82"," 00 00 01"])
C2C44.append(["Normal Read S_PAD0","01 0B 00 01 80 00"," 00 00 01"])
C2C44.append(["Normal Read S_PAD1","01 0B 00 01 80 01"," 00 00 01"])
C2C44.append(["Normal Read S_PAD2","01 0B 00 01 80 02"," 00 00 01"])
C2C44.append(["Normal Read S_PAD3","01 0B 00 01 80 03"," 00 00 01"])
C2C44.append(["Normal Read S_PAD4","01 0B 00 01 80 04"," 00 00 01"])
C2C44.append(["Normal Read S_PAD5","01 0B 00 01 80 05"," 00 00 01"])
C2C44.append(["Normal Read S_PAD6","01 0B 00 01 80 06"," 00 00 01"])
C2C44.append(["Normal Read S_PAD7","01 0B 00 01 80 07"," 00 00 01"])
C2C44.append(["Normal Read S_PAD8","01 0B 00 01 80 08"," 00 00 01"])
C2C44.append(["Normal Read S_PAD9","01 0B 00 01 80 09"," 00 00 01"])
C2C44.append(["Normal Read S_PAD10","01 0B 00 01 80 0A"," 00 00 01"])
C2C44.append(["Normal Read S_PAD11","01 0B 00 01 80 0B"," 00 00 01"])
C2C44.append(["Normal Read S_PAD12","01 0B 00 01 80 0C"," 00 00 01"])
C2C44.append(["Normal Read S_PAD13","01 0B 00 01 80 0D"," 00 00 01"])
C2C44.append(["Normal Read Reg","01 0B 00 01 80 0E"," 00 00 01 FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF"])
C2C44.append(["Normal Read RC","01 0B 00 01 80 80"," 00 00 01"])
C2C44.append(["Normal Read MAC","01 0B 00 01 80 81"," 00 00 01"])
C2C44.append(["Normal Read ID","01 0B 00 01 80 82"," 00 00 01"])
C2C44.append(["Normal Read D_ID","01 0B 00 01 80 83"," 00 00 01"])
C2C44.append(["Normal Read SER_C","01 0B 00 01 80 84"," 00 00 01"])
C2C44.append(["Normal Read SYS_C","01 0B 00 01 80 85"," 00 00 01"])
C2C44.append(["Normal Read CKV","01 0B 00 01 80 86"," 00 00 01"])
C2C44.append(["Normal Read CK","01 0B 00 01 80 87"," 00 00 01"])
C2C44.append(["Normal Read MC","01 0B 00 01 80 88"," 00 00 01"])
C2C44.append(["Normal Read WCNT","01 0B 00 01 80 90"," 00 00 01"])
...
for Case in C2C44:
	command = "2C 44 0F 06"+strUID+Case[1]
	response = "2C 00 00 1C 07"+strUID+Case[2]
