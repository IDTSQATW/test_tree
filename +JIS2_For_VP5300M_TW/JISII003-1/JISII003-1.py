				...
				if sResult!=None and sResult!="":
					...
					if CardData!=None and CardData!='':
						...
						if objectMSR!=None:
							...
							TR1maskdata = "%*4649********0675^CHANG JEN CHUN            ^2404***************************?*"
							TR2maskdata = ";4649********0675=2404****************?*"
							TR1plaintextdata = "2542343634393631303132343030303637355E4348414E47204A454E204348554E2020202020202020202020205E323430343230313130343734303030303030303030303136383030303030303F59"
							TR2plaintextdata = "3B343634393631303132343030303637353D32343034323031313034373431363830303030303F3A"
							...
							Result = DL.Check_StringAB(CardData, '02 3A 01 80 1F 4F 28 00 B3 9B')
							if Result == False:
