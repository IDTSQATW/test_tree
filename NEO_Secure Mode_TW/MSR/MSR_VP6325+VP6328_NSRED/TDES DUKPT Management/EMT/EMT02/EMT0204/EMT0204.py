		...
		if (Result):
			for i in range (1, 11):
				...
				if (RetOfStep):		
					if j == 1:
						if i == 1:
							Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** 28 DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 3F 4F 28 6B 87 00")
						if i == 2:
						...
						if i == 5:
							Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** 28 DF EE 25 02 00 11 DF EE 23 ** 02 ** 81 3F 30 23 52 87 00")
						if i == 6:
							Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** 28 DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 1F 3D 26 00 83 00")
						if i == 7:
					...
					if j == 2:
						...
						if (Result):
							Result = DL.Check_StringAB(DL.Get_RXResponse(1),"28 DF EE 25 02 00 11 DF EE 23")
							if (Result):
								if i == 1:
