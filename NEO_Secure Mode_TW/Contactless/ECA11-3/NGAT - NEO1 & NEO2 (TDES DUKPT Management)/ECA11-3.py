...
if (Result):
	...
	if (RetOfStep):
		...
		if platform == 0: #NEOI
			Result = DL.Check_RXResponse(1, "56 69 56 4F 74 65 63 68 32 00 03 23 ** D3 ** FFEE12")
		...
		if (Result):
			...
			if platform == 1: #NEOII and upward
				Result = DL.Check_RXResponse(1, "DFEE26 02 F300")
			if platform == 0: #NEOI
				Result = DL.Check_RXResponse(1, "DFEE26 01 D3")
			if Result == False:
				DL.fails=DL.fails+1
