...
if (Result):
	RetOfStep = DL.SendCommand('Set Encryption type -- TransArmor TDES')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("C7 00 00 00")
		
# Get Encryption type -- TransArmor TDES
if (Result):
	RetOfStep = DL.SendCommand('Get Encryption type -- TransArmor TDES')
	if (RetOfStep):
		...
		if (Result):
			for k in range (1, 3):
				...
				if i == 1:
					...
					Result = DL.Check_StringAB(decDFEF4D, '25 42 36 35 31 30 30 30 30 30 30 30 30 30 30 31 32 35 5E 43 41 52 44 2F 49 4D 41 47 45 20 30 38 20 20 20 20 20 20 20 20 20 20 20 20 20 5E 31 37 31 32 32 30 31 31 30 30 30 30 39 35 30 30 30 30 30 30 3F')
					
					if Result == True and DL.Check_StringAB(alldata, 'DF EF 4D 48'):
				...
				if i == 2:
					...
					Result = DL.Check_StringAB(decDFEF4D, '3B 36 35 31 30 30 30 30 30 30 30 30 30 30 31 32 35 3D 31 37 31 32 32 30 31 31 30 30 30 30 39 35 30 30 30 30 30 30 3F')
					if Result == True and DL.Check_StringAB(alldata, 'DF EF 4D 28'):
						DL.SetWindowText("blue", "Tag DFEF4D: PASS")
					else:
						DL.SetWindowText("red", "Tag DFEF4D: FAIL")
				...
				if i == 4:
					...
					Result = DL.Check_StringAB(decDFEF4D, '25 42 36 35 31 30 30 30 30 30 30 30 30 30 30 31 32 35 5E 43 41 52 44 2F 49 4D 41 47 45 20 30 38 20 20 20 20 20 20 20 20 20 20 20 20 20 5E 31 37 31 32 32 30 31 31 30 30 30 30 39 35 30 30 30 30 30 30 3F 3B 36 35 31 30 30 30 30 30 30 30 30 30 30 31 32 35 3D 31 37 31 32 32 30 31 31 30 30 30 30 39 35 30 30 30 30 30 30 3F')
					if Result == True and DL.Check_StringAB(alldata, 'DF EF 4D 70'):
						DL.SetWindowText("blue", "Tag DFEF4D: PASS")
					else:
						DL.SetWindowText("red", "Tag DFEF4D: FAIL")
