...
if (Result):
	...
	if (RetOfStep):
		...
		DL.Check_StringAB(DL.Get_RXResponse(1), '71 FF EE 12')
	...
	# Tag FFEE13
		...
		if Result == True and DL.Check_StringAB(alldata, "FF EE 13 A1 39"):
		...
		if Result == True and DL.Check_StringAB(alldata, "FF EE 13 C1"):
	...
	# Tag FFEE14
		...
		if Result == True and DL.Check_StringAB(alldata, "FF EE 14 C1"):
