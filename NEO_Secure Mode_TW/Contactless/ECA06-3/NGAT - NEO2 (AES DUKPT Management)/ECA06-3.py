	...
	if (RetOfStep):
        ...
        if (Result):
            ...
            # Tag 56
                ...
                r3 = DL.Check_StringAB(mask56, '5E 34 39 31 32 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A')
            ...
            # Tag 57
                ...
                r2 = DL.Check_StringAB(mask57, '1D 49 12 CC CC CC CC CC CC')
                ...
                r1 = DL.Check_StringAB(dec57, '57 12 36 07 05 00 00 00')
                r2 = DL.Check_StringAB(dec57, '1D 49 12 10')
