...
T0240 = []
T0240.append(["ACT-Only MSR","1E 9F 02 06 00 00 00 00 02 00 9C 01 00 DF EF 37 01 03","02 ** DF EE 23"])
...
if (DeviceType!=14 and DeviceType!=15):
	...
	#MSR
	if(False==Pro_SendCmd().RunCK( Tra_Type_1().Run(T0240[0][0],1,T0240[0][1],RobotAction2,Robot,50000,200,DL),T0240[0][2],DL)):DL.fails=DL.fails+1
