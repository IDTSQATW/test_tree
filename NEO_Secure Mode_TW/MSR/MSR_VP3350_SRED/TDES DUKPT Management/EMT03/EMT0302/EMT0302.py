			...
			for i in range (1, 11):
				...
				if (RetOfStep):		
					...
					if j == 2:
						...
						if (Result):
							Result = DL.Check_RXResponse(1,"E8 DF EE 25 02 00 11 DF EE 23")
							if (Result):
								if i == 1:
									Result = DL.Check_RXResponse(1,"83 3F 4F 28 6B 87 00")
								if i == 2:
									Result = DL.Check_RXResponse(1,"80 1F 44 28 00 A3 9B")
								if i == 3:
									Result = DL.Check_RXResponse(1,"80 1F 48 28 00 A3 9B")
								if i == 4:
									Result = DL.Check_RXResponse(1,"85 17 00 48 00 82 00")
								if i == 5:
									Result = DL.Check_RXResponse(1,"81 3F 30 23 52 87 00")
								if i == 6:
									Result = DL.Check_RXResponse(1,"80 1F 3D 26 00 83 9B")
								if i == 7:
									Result = DL.Check_RXResponse(1,"83 0F 3B 00 00 81 00")
								if i == 8:
									Result = DL.Check_RXResponse(1,"80 0F 3A 00 00 A1 89")
								if i == 9:
									Result = DL.Check_RXResponse(1,"83 0F 42 00 00 81 00")
								if i == 10:
									Result = DL.Check_RXResponse(1,"80 3F 4D 27 69 87 BF")
