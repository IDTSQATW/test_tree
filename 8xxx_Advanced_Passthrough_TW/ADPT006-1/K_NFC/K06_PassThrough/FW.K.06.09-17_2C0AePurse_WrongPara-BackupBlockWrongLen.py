...
C2C0A = []
C2C0A.append(["Inc with backup - Backup block length less than 01","2C 0A B2 10 04 01 00 00 00 11 00","5669564F7465636832002C05"])
C2C0A.append(["Dec with backup - Backup block length between 01 and 08","2C 0A 32 10 04 01 00 00 00 11 02 11 01","5669564F7465636832002C05"])
C2C0A.append(["Inc with backup - Backup block length more than 08","2C 0A B2 10 04 01 00 00 00 11 09 10 01 FF FF FF FF FF FF FF","5669564F7465636832002C05"])
