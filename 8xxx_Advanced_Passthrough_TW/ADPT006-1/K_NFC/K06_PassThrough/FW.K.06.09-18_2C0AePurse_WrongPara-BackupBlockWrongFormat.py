...
C2C0A = []
C2C0A.append(["Dec with backup - Backup block not complete","2C 0A 32 10 04 01 00 00 00 11","5669564F7465636832002C05"])
C2C0A.append(["Dec with backup - Backup block data not correspond to length(08)","2C 0A 32 10 04 01 00 00 00 11 08 10 01 FF FF FF FF FF","5669564F7465636832002C07"])
