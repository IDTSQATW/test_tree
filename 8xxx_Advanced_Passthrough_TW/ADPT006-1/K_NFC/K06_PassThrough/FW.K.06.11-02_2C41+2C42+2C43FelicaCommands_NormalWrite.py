...
C2C41.append(["Normal Read S_PADx -- BLOCK 03","2C 41 06 01 0B 00 01 80 03","2C 00 00 13 00 00 01 03 03 03 03 03 03 03 03 03 03 03 03 03 03 03 03"])
C2C41.append(["Normal Write S_PADx -- BLOCK 03","2C 41 08 01 09 00 01 80 03 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00","56 69 56 4F 74 65 63 68 32 00 2C 00"])
C2C41.append(["Normal Read S_PADx-x+3 -- BLOCK 03, 06, 04, 05","2C 41 06 01 0B 00 04 80 03 80 06 80 04 80 05  ","56 69 56 4F 74 65 63 68 32 00 2C 00 00 43 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"])

T2C40=[]
T2C40.append(["Please Tap Felica Card","FF 0A","2C 00 00 09 0C ",CardList[0]])
