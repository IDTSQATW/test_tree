...
C2C13 = []
C2C13.append(["PPSE ","2C 13 00 00 A4 04 00 0E 32 50 41 59 2E 53 59 53 2E 44 44 46 30 31 00  ","56 69 56 4F 74 65 63 68 32 00 2C00 0052 0030** 9000 000A** 0010","00 25 6F 23 84 0E 32 50 41 59 2E 53 59 53 2E 44 44 46 30 31 A5 11 BF 0C 0E 61 0C 4F 07 A0 00 00 00 04 10 10 87 01 01"])
...
C2C13.append(["Read Record ","2C 13 00 00 B2 01 0C 00 ","56 69 56 4F 74 65 63 68 32 00 2C00 00B2 0090** 9000 000A** 0010","00 7F 70 7D 9F 6C 02 00 01 9F 62 06 00 00 00 38 00 00 9F 63 06 00 00 00 00 E0 E0 56 3C 42 35 34 31 33 33 33 30 30 38 39 36 30 30 30 31 30 5E 45 54 45 43 2F 50 41 59 50 41 53 53 5E 31 34 31 32 32 30 31 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 9F 64 01 03 9F 65 02 00 0E 9F 66 02 0E 70 9F 6B 13 54 13 33 00 89 60 00 10 D1 41 22 01 90 00 99 00 00 00 0F 9F 67 01 03"])
C2C13.append(["CCC","2C 13 00 80 2A 8E 80 04 00 00 00 00 00","56 69 56 4F 74 65 63 68 32 00 2C00 0042 0020** 9000 000A** 0010","00 11 77 0F 9F 60 02 A0 A9 9F 61 02 D9 B1 9F 36 02 00 02"])
...
for case in C2C13:
    ...
    ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,True,True,case[3],DL)
