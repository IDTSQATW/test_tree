...
C2C0A = []
C2C0A.append(["Dec without backup - Function block not complete","2C 0A 31 10","5669564F7465636832002C05"])
C2C0A.append(["Dec without backup - Function block data not correspond length","2C 0A 31 10 04 01 00 00","2C070000"])
