...
# if (Result):
	...
	# DL.SendIOCommand("IDG", "04 00 DF EE 44 02 FF FF DF EE 34 06 00 00 00 03 00 00 5F 2A 02 01 56 DF ED 5B 04 01 06 00 08 DF ED 5A 08 01 00 00 00 00 00 00 00 DF EE 0C 01 08 DF EE 6B 08 54 65 72 6D 30 30 30 30", 3000, 1) 
...
# CL test
if (Result):
	rx = 6 # for VP3350, is 6
	DL.SetWindowText("black", "*** 02-40 (enable CL only), tap CUP QUICS...")
	DL.SendIOCommand("IDG", "02 40 0A 9A 03 07 11 21 9F 21 03 10 15 20 9F 02 06 00 00 00 00 10 00 DF EF 37 01 02", 10000, rx+1) 
	if (RetOfStep):
...
# if (Result):
	...
	# DL.SendIOCommand("IDG", "03 03 00 E3 00 06 31 32 33 34 35 36 9A 03 15 07 30 9F 21 03 10 10 10", 3000, 2) 
	# time.sleep(3)