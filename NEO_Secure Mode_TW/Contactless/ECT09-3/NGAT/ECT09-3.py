...
if (Result):
    ...
    if (RetOfStep):
        ...
        # Tag DFEF17
            ...
            if Result == True and DL.Check_StringAB(alldata, 'DF EF 17 A1 3E'):
            ...
            if Result == True and DL.Check_StringAB(alldata, 'DF EF 17 C1'):
        ...
        # Tag DFEF18
            ...
            if Result == True and DL.Check_StringAB(alldata, "DF EF 18 C1"):
