...
if (Result):
	...
	if (RetOfStep):
		...
		if lcdtype == 0:
			DL.Check_RXResponse(3, "56 69 56 4F 74 65 63 68 32 00 02 23 ** E1 ** DF EE 12")	
	...
	# Tag 57
		...
		if Result == True and DL.Check_RXResponse(alldata, "57 A1 13"):
			DL.SetWindowText("blue", "Tag 57_Mask: PASS")
		else:
			DL.SetWindowText("red", "Tag 57_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec57, '57 13 47 61 73 90 01 01 00 10 D3 01 21 20 00 12 33 99 00 03 1F')
		if Result == True and DL.Check_RXResponse(alldata, "57 C1 20"):
	...
	# Tag 5A
		...
		if Result == True and DL.Check_RXResponse(alldata, "5A A1 08"):
			DL.SetWindowText("blue", "Tag 5A_Mask: PASS")
		else:
			DL.SetWindowText("red", "Tag 5A_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec5A, '5A 08 47 61 73 90 01 01 00 10')
		if Result == True and DL.Check_RXResponse(alldata, "5A C1 10"):
