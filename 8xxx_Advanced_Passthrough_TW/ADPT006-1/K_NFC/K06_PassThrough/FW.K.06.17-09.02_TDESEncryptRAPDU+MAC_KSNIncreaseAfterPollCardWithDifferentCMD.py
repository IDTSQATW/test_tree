...
C2C07= []
C2C07.append(["Read Block #1 - 11","2C 07 41 01","5669564F7465636832002C00 0038 0018** 000A** 0010","0010 "])

C2C40 = []
C2C40.append(["Poll tag 2","2C 40 FF 22","2C 00 00 08 0B "])
C2C40.append(["Tag2 Read Data(16 bytes)","2C 40 21 06","2C 00 0038 0018** 000A** 0010","00 10 ?? ?? ?? ??"])
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,1,True,True,C2C03[0][3],DL)
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,1,False,True,C2C40[1][3],DL)
ListKSN.append(ListAPDU[0])
if(Robot):DL.Robot_RemoveCard()
