...
if (Result):
	...
	# cmd 02-40		
	if (Result):
		DL.SetWindowText("black", "*** cmd 02-40, Mifare Ultralight..........")
		...
		Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 50")
		if (Result):
...
if (Result):
	...
	# cmd 02-40		
	if (Result):
		DL.SetWindowText("black", "*** cmd 02-40, Mifare Ultralight C..........")
		DL.SendIOCommand("IDG", "02 40 0A 9F 02 06 00 00 00 00 00 01 5F 2A 02 09 78 9A 03 11 09 27 9F 21 03 10 15 20 9F 1A 02 00 56 9C 01 00", 32000, 1) 
		Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 50")
		if (Result):
			DL.SetWindowText("black", "*** >>> Buzzer >>> Poll For Token >>> PT Stop..........")
...
if (Result):
	...
	# cmd 02-40		
	if (Result):
		DL.SetWindowText("black", "*** cmd 02-40, ViVOtech ..........")
		DL.SendIOCommand("IDG", "02 40 0A 9F 02 06 00 00 00 00 00 01 5F 2A 02 09 78 9A 03 11 09 27 9F 21 03 10 15 20 9F 1A 02 00 56 9C 01 00", 32000, 1) 
		Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 50")
		if (Result):
			DL.SetWindowText("black", "*** >>> Buzzer >>> Poll For Token >>> PT Stop..........")
