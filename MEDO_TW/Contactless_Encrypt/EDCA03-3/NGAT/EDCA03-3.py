		...
		if (Result):
			for k in range (1, 2):
				...
				if i == 1:
					...
					Result = DL.Check_StringAB(decDFEF4D, '42 35 31 32 38 35 37 30 31 30 30 30 33 38 30 37 32 5E 20 2F 5E 31 38 30 33 36 32 32 30 30')
				...
				if i == 2:
					...
					Result = DL.Check_StringAB(decDFEF4D, '35 31 32 38 35 37 30 31 30 30 30 33 38 30 37 32 3D 31 38 30 33 36 32 32 30')
					if Result == True and DL.Check_StringAB(alldata, 'DF EF 4D 30'):
						DL.SetWindowText("blue", "Tag DFEF4D: PASS")
					else:
						DL.SetWindowText("red", "Tag DFEF4D: FAIL")
				...
				if i == 4:
					...
					if (Result):
						Result = DL.Check_StringAB(decDFEF4D, '35 31 32 38 35 37 30 31 30 30 30 33 38 30 37 32 3D 31 38 30 33 36 32 32 30')
					if Result == True and DL.Check_StringAB(alldata, 'DF EF 4D 50'):
						DL.SetWindowText("blue", "Tag DFEF4D: PASS")
					else:
						DL.SetWindowText("red", "Tag DFEF4D: FAIL")
