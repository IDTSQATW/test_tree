...
if (Result):
	RetOfStep = DL.SendCommand('Set MSR Secure Parameters (11)')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("C7 00 00 00")	
if (Result):
	RetOfStep = DL.SendCommand('Get MSR Secure Parameters')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("C7 00 00 05 DF EF 04 01 11")
		...
		if (Result):
			for i in range (1, 11):
				...
				if (RetOfStep):		
					if j == 1:
						if i == 1:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 3F 4F 28 6B 86 89")
						if i == 2:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 1F 44 28 00 A3 9B")
						if i == 3:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 86 1F 48 28 00 82 89")
						if i == 4:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 85 17 00 48 00 82 00")
						if i == 5:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 81 3F 30 23 52 86 89")
						if i == 6:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 1F 3D 26 00 83 9B")
						if i == 7:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 0F 3B 00 00 80 89")
						if i == 8:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 0F 3A 00 00 A1 89")
						if i == 9:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 0F 42 00 00 80 89")
						if i == 10:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** E8 DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 3F 4D 27 69 87 BF")
					if j == 2:
						...
						if (Result):
							...
							if (Result):
								if i == 1:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"83 3F 4F 28 6B 86 89")
								if i == 2:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"80 1F 44 28 00 A3 9B")
								if i == 3:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"86 1F 48 28 00 82 89")
								if i == 4:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"85 17 00 48 00 82 00")
								if i == 5:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"81 3F 30 23 52 86 89")
								if i == 6:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"80 1F 3D 26 00 83 9B")
								if i == 7:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"83 0F 3B 00 00 80 89")
								if i == 8:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"80 0F 3A 00 00 A1 89")
								if i == 9:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"83 0F 42 00 00 80 89")
								if i == 10:
					...
					if Result == True and sResult!=None and sResult!="":
						...
						if CardData!=None and CardData!='':
							...
							if objectMSR!=None:
								...
								DL.SetWindowText("blue", "Track 1_Hash:")
								Track1_Hash = DL.Get_HashTrackN_CardData(1)
								DL.SetWindowText("blue", "Track 2_Hash:")
								Track1_Hash = DL.Get_HashTrackN_CardData(2)
								DL.SetWindowText("blue", "Track 3_Hash:")
								Track1_Hash = DL.Get_HashTrackN_CardData(3)
