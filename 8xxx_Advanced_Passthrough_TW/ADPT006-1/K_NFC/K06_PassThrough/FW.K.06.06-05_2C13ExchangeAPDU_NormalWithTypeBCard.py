...
C2C13.append(["Select ","2C 13 00 00 A4 04 00 07 A0 00 00 00 04 10 10 00 ","56 69 56 4F 74 65 63 68 32 00 2C 00 ","56 69 56 4F 74 65 63 68 32 00 2C 00 00 1B 6F 17 84 07 A0 00 00 00 04 10 10 A5 0C 50 0A 4D 61 73 74 65 72 43 61 72 64 90 00 B9 2E"])
C2C13.append(["GPO ","2C 13 00 80 A8 00 00 02 83 00 00 ","56 69 56 4F 74 65 63 68 32 00 2C 00","56 69 56 4F 74 65 63 68 32 00 2C 00 00 0E 77 0A 82 02 00 00 94 04 08 01 01 00 90 00 0C CB"])
...
else:DL.ShowMessageBox("Poll Card", "Present PayPass card and ot move until the end",0)
