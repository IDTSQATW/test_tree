...
C2C0A = []
C2C0A.append(["Decrement without backup - CardType1","2C 0A 11 10 04 01 00 00 00","2C050000"])
C2C0A.append(["Inc without backup - CardType2","2C 0A A1 10 04 01 00 00 00","2C050000"])
C2C0A.append(["8.Dec without backup - CardType4","2C 0A 41 10 04 01 00 00 00 00","2C050000"])
C2C0A.append(["Inc without backup - CardType7","2C 0A F1 10 04 01 00 00 00 00","2C050000"])
