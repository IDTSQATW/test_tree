				...
				if sResult!=None and sResult!="":
					...
					if CardData!=None and CardData!='':
						...
						if objectMSR!=None:
							...
							TR1maskdata = "%B5520465116363404^CHANG JEN CHUN           /^220320158248000000000043000000?D"
							TR2maskdata = ";111111111111111111111111111111111111?4"
							TR3maskdata = "0000000000000000000000000000000000000000000R1011028437644416R00000000A"
							...
							TR2plaintextdata = "3B353532303436353131363336333430343D323230333230313538323438343330303030303F38"
							TR3plaintextdata = "7F3030303030303030303030303030303030303030303030303030303030303030303030303030303030303052313031313032383433373634343431365230303030303030307F41"
							...
							if TR3maskdata == Track3_CardData: 
								DL.SetWindowText("Blue", "Track 3 Mask data: PASS")
							else:
								DL.SetWindowText("Red", "Track 3 Mask data: FAIL")
							...
							#if TR3plaintextdata == TRK3DecryptData: 
							#	DL.SetWindowText("Blue", "Track 3 Decryption data: PASS")
							#else:
							#	DL.SetWindowText("Red", "Track 3 Decryption data: FAIL")
										
							# Verify specific tags
							Result = DL.Check_StringAB(CardData, '02 CE 00 86 3F 4E 27 48 B7 00')
							if Result == False:
