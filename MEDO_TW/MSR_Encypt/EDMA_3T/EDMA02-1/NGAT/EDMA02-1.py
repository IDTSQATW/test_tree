...
if (Result):
	for i in range (1, 8):
		...
		if (RetOfStep):
			...
			#1 Tag DFEF4C-4D	
			if i == 1:
				Result = DL.Check_StringAB(TagDFEF4C, '4C 00 00 00 00 00')
				if Result == True:
			...
			#2 Tag DFEF4C-4D	
			if i == 2:
				Result = DL.Check_StringAB(TagDFEF4C, '00 26 00 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
				...
				if Result == True and DL.Check_StringAB(DL.Get_RXResponse(0), 'DF EF 4D 30'):
					DL.SetWindowText("blue", "Tag DFEF4D: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4D: FAIL")
			...
			#3 Tag DFEF4C-4D	
			if i == 3:
				Result = DL.Check_StringAB(TagDFEF4C, '00 00 68 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#4 Tag DFEF4C-4D	
			if i == 4:
				Result = DL.Check_StringAB(TagDFEF4C, '4C 26 00 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#5 Tag DFEF4C-4D	
			if i == 5:
				Result = DL.Check_StringAB(TagDFEF4C, '4C 00 68 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
				...
				if Result == True and DL.Check_StringAB(DL.Get_RXResponse(0), 'DF EF 4D 81 C0'):
					DL.SetWindowText("blue", "Tag DFEF4D: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4D: FAIL")
			...
			#6 Tag DFEF4C-4D	
			if i == 6:
				Result = DL.Check_StringAB(TagDFEF4C, '00 26 68 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#7 Tag DFEF4C-4D	
			if i == 7:
				Result = DL.Check_StringAB(TagDFEF4C, '4C 26 68 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
				...
				if Result == True and DL.Check_StringAB(DL.Get_RXResponse(0), 'DF EF 4D 81 E0'):
					DL.SetWindowText("blue", "Tag DFEF4D: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4D: FAIL")