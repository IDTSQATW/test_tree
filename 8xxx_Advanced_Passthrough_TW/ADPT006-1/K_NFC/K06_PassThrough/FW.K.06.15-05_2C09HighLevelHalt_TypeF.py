...
C2C09=[]
C2C09.append(["High Level Halt Command - typeA","2C 09 01","2C 0B 00 00"])
C2C09.append(["High Level Halt Command - typeB","2C 09 02","2C 0B 00 00"])
...
else:DL.ShowMessageBox("Message","Please tap a Felica card",0)
