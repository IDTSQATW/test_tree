...
if (Result):
	...
	if (RetOfStep):
		...
		if lcdtype == 0:
			DL.Check_RXResponse(3, "56 69 56 4F 74 65 63 68 32 00 02 23 ** F1 ** DF EE 12")	
	...
	# Tag DF812A/ DF812B (only need enc data)
		...
		if Result == True and DL.Check_RXResponse(alldata, "** DF 81 2A C1 **"):
		...
		if Result == True and DL.Check_RXResponse(alldata, "** DF 81 2B C1 **"):
	...
	# Tag 56
		...
		if R1 == True and R2 == True and DL.Check_RXResponse(alldata, "** 56 A1 29 **"):
		...
		if R1 == True and R2 == True and DL.Check_RXResponse(alldata, "** 56 C1 **"):
	...
	# Tag 9F6B
		...
		if R1 == True and R2 == True and DL.Check_RXResponse(alldata, "** 9F 6B A1 13 **"):
		...
		if R1 == True and R2 == True and DL.Check_RXResponse(alldata, "** 9F 6B C1 **"):
