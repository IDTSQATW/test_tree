...
C2C06 = []
C2C06.append(["Authenticate","2C 06 10 01 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])

C2C07 = []
C2C07.append(["Read 3 Initialized Blocks - No change","2C 07 33 10","5669564F7465636832002C000030 8719000078E6FFFF8719000000FF00FF B71A000048E5FFFFB71A000000FF00FF 8819000077E6FFFF8819000000FF00FF4CD2"])
C2C07.append(["Read 3 Initialized Blocks - changed","2C 07 33 10","5669564F7465636832002C000030 8619000079E6FFFF8619000000FF00FF B71A000048E5FFFFB71A000000FF00FF 8819000077E6FFFF8819000000FF00FF"])
...
C2C0A = []
C2C0A.append(["Dec with backup -Backup block with wrong key","2C 0A 32 10 04 01 00 00 00 11 08 10 01 FF FF FF FF FF 11","5669564F7465636832002C0A00021110"])
