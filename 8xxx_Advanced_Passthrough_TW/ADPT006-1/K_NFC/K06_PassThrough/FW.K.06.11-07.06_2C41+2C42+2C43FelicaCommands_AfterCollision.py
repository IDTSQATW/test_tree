...
T0240 = []
T0240.append(["ACT-CTLS","02 40 0A 9F 02 06 00 00 00 00 02 00 9C 01 00 DF EF 37 01 02",["02 08 ** DF EE 02 04 21 "]])

C2C01 = [["Passthrough Enable","2C0101","2C00"],["Passthrough Disable","2C0100","2C00"]]

T2C40 = []
T2C40.append(["Please Tap Felica Card, not remove until next message","FF 0A","2C 00 00 09 0C "])
...
DL.ShowMessageBox("Message","Please tap TWO cards then wait until timeout after clicking",0)
