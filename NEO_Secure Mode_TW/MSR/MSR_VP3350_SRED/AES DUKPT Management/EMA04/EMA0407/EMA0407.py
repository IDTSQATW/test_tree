		...
		if (Result):
			for i in range (1, 11):
				...
				if (RetOfStep):		
					if j == 1:
						if i == 1:
							Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 7F 4F 28 6B 90 BF")
						if i == 2:
						...
						if i == 5:
							Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 81 7F 30 23 52 90 BF")
						if i == 6:
					...
					if j == 2:
						...
						if (Result):
							...
							if (Result):
								if i == 1:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"83 7F 4F 28 6B 90 BF")
								if i == 2:
								...
								if i == 5:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"81 7F 30 23 52 90 BF")
								if i == 6:
