		...
		if (Result):
			for i in range (1, 11):
				...
				if (RetOfStep):		
					if j == 1:
						if i == 1:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 3F 4F 28 6B 93 A4")
						if i == 2:
						...
						if i == 5:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 81 3F 30 23 52 93 A4")
						if i == 6:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 1F 3D 26 00 93 9B")
						if i == 7:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 0F 3B 00 00 91 00")
						if i == 8:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 0F 3A 00 00 B1 89")
						if i == 9:
							Result = DL.Check_RXResponse(0, "56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 83 0F 42 00 00 91 00")
						if i == 10:
					...
					if j == 2:
						...
						if (Result):
							...
							if (Result):
								if i == 1:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"83 3F 4F 28 6B 93 A4")
								if i == 2:
								...
								if i == 5:
									Result = DL.Check_StringAB(DL.Get_RXResponse(1),"81 3F 30 23 52 93 A4")
								if i == 6:
