...
C2C07 = []
C2C07.append(["ReadBlock6","2C 07 41 05","56 69 56 4F 74 65 63 68 32 00 2C 00 00 10 ?? ?? ?? ?? 11 11 11 11"])
C2C07.append(["ReadBlock6","2C 07 41 05","56 69 56 4F 74 65 63 68 32 00 2C 00 00 10 ?? ?? ?? ?? 00 00 00 00"])
