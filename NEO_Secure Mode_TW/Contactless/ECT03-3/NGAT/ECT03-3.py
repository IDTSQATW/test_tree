...
if (Result):
	...
	if (RetOfStep):
		Result = DL.Check_RXResponse(rx, "56 69 56 4F 74 65 63 68 32 00 02 23 ** F1 ** DF EE 12")
        if (Result):
            ...
            Result = DL.Check_StringAB(decDF812A, 'DF 81 2A 18 30 30 30 31 30 30 30 30 30 31 30 30 31 31 31 31 31 31 31 31 31 31 31 32 00000000')
            ...
            Result = DL.Check_StringAB(decDF812B, 'DF 81 2B 07 00 01 00 00 01 00 2F 0000000000')
            ...
            if Result == True and DL.Check_RXResponse(rx, "** 56 A1 3E **"):
