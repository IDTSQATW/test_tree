...
if (Result):
	...
	# Tag DFEF17
		...
		if Result == True and DL.Check_StringAB(alldata, "DF EF 17 A1 41"):
		...
		if Result == True and DL.Check_StringAB(alldata, "DF EF 17 C1 50"):
	...
	# Tag DFEF18
		...
		if Result == True and DL.Check_StringAB(alldata, "DF EF 18 A1 25"):
		...
		if Result == True and DL.Check_StringAB(alldata, "DF EF 18 C1 30"):
	...
	# Tag 56
		...
		if Result == True and DL.Check_StringAB(alldata, "56 A1 41"):
		...
		if Result == True and DL.Check_StringAB(alldata, "56 C1 50"):
