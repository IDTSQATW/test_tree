...
C2C09=[]
C2C09.append(["High Level Halt Command - typeB","2C 09 02","2C 00 00 00"])
C2C09.append(["High Level Halt Command - typeA","2C 09 01","2C 06 00 00"])
...
DL.ShowMessageBox("Message","Please tap a type B CTLS cardr",0)
...
if (False == DL.ShowMessageBox("Message","Spy log contain HLTB? Resatrt recording before clicking",0)):DL.fails = DL.fails +1
