...
if (Result):
    ...
    if (RetOfStep):
        if platform == 1: #NEOII and upward
            Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 23 ** 71 ** DF EE 12")
            ksn = DL.GetTLV(alldata,"DFEE12")
        if platform == 0: #NEOI
            Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 23 ** 51 ** FFEE12")
        ...
        # Tags 9F39/ FFEE01/ DFEE26
            ...
            if platform == 1: #NEOII and upward
                Result = DL.Check_RXResponse("DFEE26 02 7100")
            if platform == 0: #NEOI
                Result = DL.Check_RXResponse("DFEE26 01 51")
            if Result == False:
                DL.fails=DL.fails+1
