...
# Check data encryption TYPE is TDES DUKPT Management/ AES/ PIN Key	
if (Result):
	RetOfStep = DL.SendCommand('Get DUKPT DEK Attribution based on KeySlot (C7-A3)')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("C7 00 00 06 00 01 01 00 00 00")
		if Result == False:
			DL.SetWindowText("red", "Data key should be: TDES DUKPT Management/ AES/ PIN Key, please check setting first...")
			...
			if i == 2 or i == 5:
				if (RetOfStep):
					...
					if readermodel == 1:	
						...
						dec5A = DL.DecryptDLL(1,2, strKey, ksn, enc5A)
					# Tag 57
			...
			if i == 3:						
				...
				if (Result):
					...
					if (Result):
						...
						if DL.Check_RXResponse(rx, "DFEE26 ** E200") == False: 
							DL.SetWindowText("Red", "Tag DFEE26: FAIL")
