...
#define ERR_CANNOT_FIND_IMAGE_FILE					0xB3
#define ERR_CANNOT_DOWNLOAD_IMAGE_FILE				0xB4
#define ERR_CANNOT_ENTER_BOOTUP_MODE				0xB5
#define ERR_NO_DEVICES_FOUND						0xB6
