	...
	if (RetOfStep):
		...
		if (Result):
			...
			# Tags 9F39/ FFEE01/ DFEE26
				...
				if DL.Check_StringAB(TagDFEE26, '6201') == False:
			...
			if (RetOfStep):
				...
				if (Result):
					...
					if (Result):
						...
						if (RetOfStep):
							DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 60 00 ** 62 ** 9F 10 07 06 01 1A 03 90 00 00 9F 26 08 ** 9F 27 01 80 9F 36 02 00 01 9F 37 04 ** 9F 02 06 00 00 00 00 02 00 9F 4D 00 9F 13 00 95 05 ** 9B 02 ** 9F 03 06 00 00 00 00 00 00 9F 34 03 5F 03 02 9F 39 01 05")
					...
					if (RetOfStep):
						...
						if (Result):
							...
							if (Result):
								...
								if (RetOfStep):
									DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 60 00 ** 62 ** 9F 10 07 06 01 1A 03 60 00 00 9F 26 08 ** 9F 27 01 40 9F 36 02 00 01 9F 37 04 ** 9F 02 06 00 00 00 00 02 00 9F 4D 00 9F 13 00 95 05 ** 9B 02 ** 9F 03 06 00 00 00 00 00 00 9F 34 03 5F 03 02 99 00 9F 5B 00 9F 39 01 05")				