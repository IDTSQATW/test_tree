#ID:Mifare-AuthWrongKey

# Head #########################################
#LABLE:
#POURPOSE: Auth with wrong key,then reject operation card (with/out re-polling card) + Re-auth with correct key, operate card successfully
#INPUT:
#OUTPUT: 
#################################################
...
C0400 = []#Kiosk only
C0400.append(["Disable Authenticate","04 00 DF ED 5E 01 00","5669564F74656368320004"])
C0400.append(["Enable Authenticate","04 00 DF ED 5E 01 01","5669564F74656368320004"])

C2C01 = []
C2C01.append(["PT Stop","2C 01 00","5669564F7465636832002C00"])
...
C2C06 = []
C2C06.append(["Authenticate with INVALID Key","2C 06 04 01 11 22 33 44 55 66","5669564F7465636832002C000000"])
C2C06.append(["Mifare auth","2C 06 01 01 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])

C2C07 = []
C2C07.append(["MiFare Read 1 Block","2C 07 31 04","5669564F7465636832002C0A0000DB5A"])
C2C07.append(["MiFare Read 1 Block","2C 07 31 04","5669564F7465636832002C000010"])
...
Pro_SendCmd().Run(C2C01[0][0],C2C01[0][1],5000,False,DL)
if(10<DeviceType):
...
#Read success if re-auth with correct key
