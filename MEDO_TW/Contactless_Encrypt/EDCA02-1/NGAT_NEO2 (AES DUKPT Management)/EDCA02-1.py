	...
	for i in range (1, 8):
		...
		if (Result):
			for k in range (1, pollmode):
				...
				#2 Tag DFEF4C-4D	
				if i == 2:
					Result = DL.Check_RXResponse(rx, 'DFEF4C 06 00 27 00 00 00 00')
					if Result == True:
						DL.SetWindowText("blue", "Tag DFEF4C: PASS")
					else:
						DL.SetWindowText("red", "Tag DFEF4C: FAIL")
								
					Result = DL.Check_StringAB(decDFEF4D, '3B 34 37 36 31 37 33 39 30 30 31 30 31 30 30 31 30 3D 33 30 31 32 31 32 30 30 30 31 32 33 33 39 39 30 30 30 33 31 3F 000000000000000000')
