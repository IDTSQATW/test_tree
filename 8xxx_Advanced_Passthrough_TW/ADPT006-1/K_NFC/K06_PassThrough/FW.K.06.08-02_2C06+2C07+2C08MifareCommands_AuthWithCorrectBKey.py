...
C2C06 = []
C2C06.append(["Mifare auth - default","2C 06 01 01 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])
C2C06.append(["Mifare auth - KeyB","2C 06 17 02 22 22 22 22 22 22","5669564F7465636832002C0000001C9B"])

C2C07= []
C2C07.append(["Read Block #22","2C 07 31 16","5669564F7465636832002C000010 "])

C0930 = [["Get device memory","09 30"]]

C2C08 = []
C2C08.append(["Write Key, Block 23 - change","2C 08 31 17 FF FF FF FF FF FF 7F 07 88 69 22 22 22 22 22 22","5669564F7465636832002C0000001C9B"])
C2C08.append(["Write Key Block 23 - default","2C 08 31 17 FF FF FF FF FF FF FF 07 80 69 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])
##################################################
