...
if (Result):
	...
	if (Result):
		Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** EA DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 37 00 28 69 96 B6")
		...
		if Result == True and sResult!=None and sResult!="":
			...
			if CardData!=None and CardData!='':
				...
				if objectMSR!=None:
					...
					TR2plaintextdata = "3B 36 32 32 35 38 38 37 33 31 35 33 37 32 33 33 30 3D 34 39 31 32 31 32 30 30 37 37 37 30 37 37 36 30 38 37 37 37 3F 3F"
					...
					TR3plaintextdata = "3B 39 39 36 32 32 35 38 38 37 33 31 35 33 37 32 33 33 30 3D 31 35 36 31 35 36 30 35 30 30 30 35 30 30 30 30 30 30 31 30 31 35 36 30 38 37 37 37 32 31 34 30 30 30 30 34 39 31 32 30 3D 37 33 31 35 33 37 32 33 33 30 3D 30 30 30 30 30 30 30 30 30 3D 30 38 30 30 30 30 30 30 37 33 31 30 30 30 30 30 30 30 30 30 30 3F 3F"
