...
if (Result):
	...
	if (RetOfStep):
		DL.Check_RXResponse(1, "56 69 56 4F 70 61 79 56 33 00 02 05 23 ?? ?? D1 DF EF 17 A1 41 2A 36 30 31 31 30 30 2A 2A 2A 2A 2A 2A 34 32 37 31 5E 44 49 53 43 4F 56 45 52 2F 4E 45 54 57 4F 52 4B 20 20 20 20 20 20 20 20 20 20 5E 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A DF EF 17 C1 48 ** DF EF 18 A1 25 36 30 31 31 30 30 2A 2A 2A 2A 2A 2A 34 32 37 31 3D 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A DF EF 18 C1 30 ** 56 A1 41 2A 36 30 31 31 30 30 2A 2A 2A 2A 2A 2A 34 32 37 31 5E 44 49 53 43 4F 56 45 52 2F 4E 45 54 57 4F 52 4B 20 20 20 20 20 20 20 20 20 20 5E 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 2A 56 C1 48 ** 57 A1 13 60 11 00 CC CC CC 42 71 DC CC C1 01 CC CC CC CC CC CC CC 57 C1 18 ")
