...
CInit.append(["Authenticate","2C 06 10 01 FF FF FF FF FF FF","5669564F7465636832002C0000001C9B"])
CInit.append(["Initialize Blocks","2C 08 33 10 8619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF","5669564F7465636832002C0000001C9B"])
CInit.append(["Read Blocks 3 - DECed","2C 07 33 10","5669564F7465636832002C0000308619000079E6FFFF8619000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF"])

CePurse = []
CePurse.append(["poll for token","2C 02 1F 00","56 69 56 4F 74 65 63 68 32 00 2C 00 00 05 03",])
CePurse.append(["Increment Block *Original - plus 1 @ block 16 without BACKUP","2C 0A B1 10 04 01 00 00 00","5669564F7465636832002C0000001C9B"])
CePurse.append(["Read Blocks 3 INCed","2C 07 33 10","5669564F7465636832002C0000308719000078E6FFFF8719000000FF00FFB71A000048E5FFFFB71A000000FF00FF8819000077E6FFFF8819000000FF00FF4CD2"])
