				...
				if sResult!=None and sResult!="":
					...
					if CardData!=None and CardData!='':
						...
						if objectMSR!=None:
							...
							TR1maskdata = "%*5208********1055^KAWANO/YOSHIKI^1702***************************?*"
							TR2maskdata = ";5208********1055=1702****************?*"
							TR1plaintextdata = "2542353230383630303736373335313035355E4B4157414E4F2F594F5348494B495E313730323230313030303030202020202020202030303031333030303030303F31"
							TR2plaintextdata = "3B353230383630303736373335313035353D31373032323031303030303030313330303030303F34"
							TR3plaintextdata = "7F6139303030303936363435323038363030373637333531303535313031323030323030313230323137303230303030303030303030303030303030303030303036363532307F10"
							...
							Result = DL.Check_StringAB(CardData, '02 92 01 86 3F 43 28 48 B3 BF')
							if Result == False:
