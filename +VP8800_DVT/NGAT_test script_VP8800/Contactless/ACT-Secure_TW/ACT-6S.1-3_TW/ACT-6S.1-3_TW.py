...
if (Result):
	...
	if (RetOfStep):
		DL.Check_RXResponse(1, "56 69 56 4F 70 61 79 56 33 00 02 05 0A ?? ?? 54 90 00 05 FF 81 05 82 01 76 50 10 41 6D 65 72 69 63 61 6E 20 45 78 70 72 65 73 73 57 A1 13 37 42 45 CC CC C0 00 1D 14 10 70 2C CC CC CC CC CC CC CC 57 C1 20 ** 5A A1 08 37 42 45 CC CC C0 00 1F 5A C1 10")
