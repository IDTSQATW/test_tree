...
if (Result):
	...
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("62 99 49 01 00 00 00 00")
...
if (Result):
	...
	# Tag 5A
		Result = DL.Check_StringAB(mask5A, '5A A1 08 47 61 CC CC CC CC 01 19')
		if Result == True and DL.Check_RXResponse("5A A1 08"):
			DL.SetWindowText("blue", "Tag 5A_Mask: PASS")
		else:
			DL.SetWindowText("red", "Tag 5A_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec5A, '5A 08 47 61 73 90 01 01 01 19')
	...
	# Tag 57
		...
		Result = DL.Check_StringAB(dec57, '57 11 47 61 73 90 01 01 01 19 D2 21 22 01 17 58 92 88 89')
