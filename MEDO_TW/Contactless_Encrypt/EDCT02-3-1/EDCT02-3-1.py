	...
	for i in range (2, 3):
		# if i == 1:
			...
			# if (RetOfStep):
				...
				# time.sleep(1)
		if i == 2:
			RetOfStep = DL.SendCommand('04-00-----DFEF4B 2 = 12 00 0C')
			if (RetOfStep):
				Result = DL.Check_RXResponse("04 00 00 00")	
		# if i == 3:
		...
		if (Result):
			for k in range (1, pollmode):
				...
				if i == 2:
					...
					r1 = DL.Check_StringAB(decDFEF4D, '3B353431333333303038393630303031304431343132323031393030323939')
					r2 = DL.Check_StringAB(decDFEF4D, '3FFF')
