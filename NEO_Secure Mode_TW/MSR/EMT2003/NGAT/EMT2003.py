...
if (Result):
	...
	if (Result):
		Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** EC DF EE 25 02 00 11 DF EE 23 ** 02 ** 80 6F 72 00 68 85 AD 02 1A 00")
		...
		if Result == True and sResult!=None and sResult!="":
			...
			if CardData!=None and CardData!='':
				...
				if objectMSR!=None:
					...
					if DL.Check_RXResponse("DFEE26 02 EC07") == False:
						DL.fails=DL.fails+1
