...
if (Result):
	RetOfStep = DL.SendCommand('Get DUKPT KSN (81-0B)_0207')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("62 99 49 01 70 00 00 00")
...
if (Result):
	...
	# Tag 5A
		Result = DL.Check_StringAB(mask5A, '5A A1 07 36 07 CC CC CC 10 12')
		if Result == True and DL.Check_RXResponse("5A A1 07"):
			DL.SetWindowText("blue", "Tag 5A_Mask: PASS")
		else:
			DL.SetWindowText("red", "Tag 5A_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec5A, '5A 07 36 07 05 00 00 10 12')
	...
	# Tag 57
		...
		Result = DL.Check_StringAB(dec57, '57 13 36 07 05 00 00 10 12 D1 71 22 01 12 01 00 05 43 00 00 0F')
