...
C2C07= []
C2C07.append(["Read Block #1 - 11","2C 07 41 01","5669564F7465636832002C00 0030 0020** 000A** 0000","0010 "])

C2C40 = []
C2C40.append(["Poll tag 2","2C 40 FF 22","2C 00 00 08 0B "])
C2C40.append(["Tag2 Read Data(16 bytes)","2C 40 21 06","2C 00 0030 0020** 000A** 0000","00 10 11 11 11 11"])


C2C44 = []
C2C44.append(["Polling Felica Card","2C 44 05 00 FF FF 01 01","2C 00 00 13 01 ** 00 F1 00 00 00 01 43 00 88 B4"])
C2C44.append(["Normal Read S_PAD1 -- 00",["2C 44 0F 06","01 09 00 01 80 01"],"2C00 0030 0020** 000A** 0000",["00 1C 07","00 00 01"]])
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,True,False,C2C03[0][3],DL)
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,False,C2C07[0][3],DL)
ListKSN.append(ListAPDU[0])
#Polling with 2C-40
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,False,C2C40[1][3],DL)
ListKSN.append(ListAPDU[0])
if(Robot):DL.Robot_RemoveCard()
...
ListAPDU = Pro_Encryption().DecRAPDU(strRes,strKey,0,2,False,False,EXRAPDU,DL)
ListKSN.append(ListAPDU[0])
