...
if pf != 1:
    ...
    # Check data encryption TYPE is AES: TransArmor AES	
    if (Result):
        RetOfStep = DL.SendCommand('Get DUKPT DEK Attribution based on KeySlot (C7-A3)')
        if (RetOfStep):
            Result = DL.Check_RXResponse("C7 00 00 06 01 05 00 00 00 00")
            if Result == False:
                DL.SetWindowText("red", "Please change AES DUKPT Output Mode as TransArmor AES first...")
# else:
