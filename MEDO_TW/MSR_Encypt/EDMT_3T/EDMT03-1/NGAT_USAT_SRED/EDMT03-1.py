...
if (Result):
	for i in range (1, 8):
		...
		if (RetOfStep):
			...
			#2 Tag DFEF4C-4D	
			if i == 2:
				Result = DL.Check_StringAB(TagDFEF4C, '00 24 00 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
							
				Result = DL.Check_StringAB(decDFEF4D, '34 35 34 37 35 37 30 30 30 31 30 37 30 30 30 30 3D 31 31 30 32 31 30 31 30 30 30 30 30 33 30 36 30 30 30 3034 35 34 37 35 37 30 30 30 31 30 37 30 30 30 30')
			...
			#3 Tag DFEF4C-4D	
			if i == 3:
				Result = DL.Check_StringAB(TagDFEF4C, '00 00 66 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#4 Tag DFEF4C-4D	
			if i == 4:
				Result = DL.Check_StringAB(TagDFEF4C, '4A 24 00 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#5 Tag DFEF4C-4D	
			if i == 5:
				Result = DL.Check_StringAB(TagDFEF4C, '4A 00 66 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#6 Tag DFEF4C-4D	
			if i == 6:
				Result = DL.Check_StringAB(TagDFEF4C, '00 24 66 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#7 Tag DFEF4C-4D	
			if i == 7:
				Result = DL.Check_StringAB(TagDFEF4C, '4A 24 66 10 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
				...
				if Result == True and DL.Check_StringAB(DL.Get_RXResponse(0), 'DF EF 4D 81 E8'):
					DL.SetWindowText("blue", "Tag DFEF4D: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4D: FAIL")