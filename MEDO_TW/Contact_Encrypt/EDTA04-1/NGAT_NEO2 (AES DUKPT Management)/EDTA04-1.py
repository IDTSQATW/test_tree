			...
			if (Result):
				...
				#1 Tag DFEF4C-4D	
					if i == 1:
						...
						if Result == True and DL.Check_RXResponse(rx6010, 'DF EF 4D 10'):
				...
				#2 Tag DFEF4C-4D	
					if i == 2:
						Result = DL.Check_RXResponse(rx6010, 'DFEF4C 06 00 24 00 10 00 00')
						if Result == True:
							DL.SetWindowText("blue", "Tag DFEF4C: PASS")
						else:
							DL.SetWindowText("red", "Tag DFEF4C: FAIL")
						...
						if Result == True and DL.Check_RXResponse(rx6010, 'DF EF 4D 40'):
							DL.SetWindowText("blue", "Tag DFEF4D: PASS")
						else:
							DL.SetWindowText("red", "Tag DFEF4D: FAIL")
