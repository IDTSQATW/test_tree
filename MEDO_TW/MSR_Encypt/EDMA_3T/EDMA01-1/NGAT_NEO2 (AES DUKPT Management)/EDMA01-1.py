...
if (Result):
	for i in range (1, 2):
		...
		if (RetOfStep):
			...
			#1 Tag DFEF4C-4D	
			if i == 1:
				Result = DL.Check_RXResponse('DFEF4C 06 4A 00 00 00 00 00')
				if Result == True:
			...
			#3 Tag DFEF4C-4D	
			if i == 3:
				Result = DL.Check_RXResponse('DFEF4C 06 00 00 66 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#4 Tag DFEF4C-4D	
			if i == 4:
				Result = DL.Check_RXResponse('DFEF4C 06 4A 24 00 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#5 Tag DFEF4C-4D	
			if i == 5:
				Result = DL.Check_RXResponse('DFEF4C 06 4A 00 66 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
				...
				if Result == True and DL.Check_RXResponse('DF EF 4D 81 B0'):
					DL.SetWindowText("blue", "Tag DFEF4D: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4D: FAIL")
			...
			#6 Tag DFEF4C-4D	
			if i == 6:
				Result = DL.Check_RXResponse('DFEF4C 06 00 24 66 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
			...
			#7 Tag DFEF4C-4D	
			if i == 7:
				Result = DL.Check_RXResponse('DFEF4C 06 4A 24 66 00 00 00')
				if Result == True:
					DL.SetWindowText("blue", "Tag DFEF4C: PASS")
				else:
					DL.SetWindowText("red", "Tag DFEF4C: FAIL")
