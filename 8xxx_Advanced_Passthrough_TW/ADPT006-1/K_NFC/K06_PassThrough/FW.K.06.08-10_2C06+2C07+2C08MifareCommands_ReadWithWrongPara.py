...
C2C07Wrong = []
C2C07Wrong.append(["MiFare Read 1 Block - CardType1","2C 07 11 04","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read 1 Block - CardType2","2C 07 21 04","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read 1 Block - CardType4","2C 07 41 04","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read 1 Block - CardType5","2C 07 51 04","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read 1 Block - CardType6","2C 07 61 04","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read 1 Block - CardType7","2C 07 71 04","5669564F7465636832002C050000"])
...
#2C-07 with wrong parameters
for Case in C2C07Wrong:
