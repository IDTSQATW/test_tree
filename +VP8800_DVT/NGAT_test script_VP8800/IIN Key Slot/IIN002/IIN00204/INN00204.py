...
if (Result):
	RetOfStep = DL.SendCommand('Get DUKPT KSN (81-0B)_0204')
	if (RetOfStep):
		Result = Result and DL.Check_RXResponse("62 99 49 01 40 00 00 00")
...
if (Result):
	...
	if (RetOfStep):
		DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 00 ** C0 ")
	...
	# Tag 5A
		Result = DL.Check_StringAB(mask5A, '5A A1 08 54 57 CC CC CC CC 00 12')
		if Result == True and DL.Check_RXResponse("5A A1 08"):
			DL.SetWindowText("blue", "Tag 5A_Mask: PASS")
		else:
			DL.SetWindowText("red", "Tag 5A_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec5A, '5A 08 54 57 21 00 89 02 00 12')
	...
	# Tag 57
		...
		Result = DL.Check_StringAB(dec57, '57 11 54 57 21 00 89 02 00 12 D2 51 22 01 07 21 90 41 9F ')
