...
C2C40Tag2 = []
C2C40Tag2.append(["Poll tag 2","2C 40 FF 22","2C 00 00 08 0B ","",False])
C2C40Tag2.append(["Tag2 Write Data(4 bytes)","2C 40 22 06 11 11 11 11","2C 00 0020 0010** 000A** 0000","00 01 0A ",True])
C2C40Tag2.append(["Tag2 Read Data(16 bytes)","2C 40 21 06","2C 00 0030 0020** 000A** 0000","00 10 11 11 11 11",True])
C2C40Tag2.append(["Tag2 Select sect","2C 40 23 06"," 2C 0A 00 00 DB 5A","",False])
