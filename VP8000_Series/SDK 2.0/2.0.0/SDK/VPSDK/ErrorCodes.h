...
#define ERR_INSUFFICIENT_BUFFER_LENGTH				0xA9
#define ERR_INPUT_PARAMETER_INVALID					0xAA
#define ERR_EVENT_NOTIFICATION_ALREADY_REGISTERED	0xAB
#define ERR_EVENT_NOTIFICATION_NOT_REGISTERED		0xAC
#define ERR_ILLEGAL_BUTTON_CAPTION					0xAD
#define ERR_REQUIRED_DATA_NOT_AVAILABLE				0xAE
#define ERR_CANNOT_FREE_MEMORY						0xAF
#define ERR_RESPONSE_REDIRECTED_TO_CALLBACK			0xB0
#define ERR_NO_EVENT_NOTIFICATION_TO_UNREGISTER		0xB1
