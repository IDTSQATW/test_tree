...
C2C0C = []
C2C0C.append(["Tap Desfire card after pressing pass","1E 00 00 01","56 69 56 4F 74 65 63 68 32 00 2C 00 00 ?? 0E","ROBOT:CTLSCARD26"])
C2C0C.append(["Tap Desfire card after pressing pass","1E 00 00 02","56 69 56 4F 74 65 63 68 32 00 2C 00 00 ?? 0E","ROBOT:CTLSCARD26"])
C2C0C.append(["Tap Desfire card after pressing pass","1E 00 00 03","56 69 56 4F 74 65 63 68 32 00 2C 00 00 ?? 0E","ROBOT:CTLSCARD26"])
