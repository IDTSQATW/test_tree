...
# Set Configuration
if (Result):
	DL.SetWindowText("black", "*** Set Configuration as default")
...
if (Result):
	...
	DL.SendIOCommand("IDG", "04 00 DF EE 44 02 FF FF", 5000, 1) 
	Result = DL.Check_RXResponse("04 00 00 00")	
	
# cmd 02-40
if (Result):
	DL.SetWindowText("black", "*** cmd 02-40")
	DL.SetWindowText("red", "[Please tap Card 57#-JCB_EMV card..........]")
	DL.SendIOCommand("IDG", "02 40 1F 9F 02 06 00 00 00 00 10 00 DF EF 37 01 02", 32000, 1) 
	Result = DL.Check_RXResponse("56 69 56 4F 74 65 63 68 32 00 02 ** E1")
	if (Result):
		...
		Result = DL.Check_StringAB(dec57, '57 13 35 40 82 99 99 42 10 12 D4 91 22 01 55 55 55 55 55 55')
		if Result == True and DL.Check_RXResponse("57 C1 ** F"):
		...
		# Tag 5A
		if DL.Check_RXResponse('5A A1 08 35 40 CC CC CC CC 10 12'):
			DL.SetWindowText("blue", "Tag 5A_Mask: PASS")
		else:
			DL.fails=DL.fails+1
			DL.SetWindowText("red", "Tag 5A_Mask: FAIL")
			
		Result = DL.Check_StringAB(dec5A, '5A083540829999421012')
