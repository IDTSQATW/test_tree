...
C2C07Wrong = []
C2C07Wrong.append(["MiFare Read - length-1","2C 07 31","5669564F7465636832002C050000"])
C2C07Wrong.append(["MiFare Read - length+1","2C 07 31 04 05","5669564F7465636832002C050000"])
