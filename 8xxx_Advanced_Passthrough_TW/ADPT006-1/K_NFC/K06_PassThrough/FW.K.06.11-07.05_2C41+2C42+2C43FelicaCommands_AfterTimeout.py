...
T0240 = []
T0240.append(["ACT-All interface","02 40 05 9F 02 06 00 00 00 00 02 00 9C 01 00 DF EF 37 01 07",["02 63","02 08"]])
T0240.append(["ACT-All interface","02 40 05 9F 02 06 00 00 00 00 02 00 9C 01 00 DF EF 37 01 06",["02 63","02 08"]])
...
#Timeout
if(Robot==False):DL.ShowMessageBox("Message","Please remove all card, wait timeout",0)
if (DeviceType!=14 and DeviceType!=15):
...
#Felica Timeout
if(Robot):DL.Robot_CTLSCard(12)
else:DL.ShowMessageBox("Message","Please tap Felica card, not remove until next message",0)
if (DeviceType!=14 and DeviceType!=15):
	if(False==Pro_SendCmd().RunCK_1( Pro_SendCmd().Run_1(2,T0240[0][0],T0240[0][1],50000,False,DL),T0240[0][2],DL)):DL.fails=DL.fails+1
else:
	if(False==Pro_SendCmd().RunCK_1( Pro_SendCmd().Run_1(2,T0240[0][0],T0240[0][1],50000,False,DL),T0240[0][2],DL)):DL.fails=DL.fails+1
